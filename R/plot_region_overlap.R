...
overlap_data_polya$Graph = recode_factor(overlap_data_polya$Graph, 
                                         ...
                                         "1kg_nonCEU_af001_gencode100_gtex10s2r8e1g" = "1000g (no-CEU) + GTEx introns")
...
overlap_data_polya_mapq_bar <- overlap_data_polya_mapq_bar %>%
 ungroup() %>%
  ...
  add_row(Method = "HISAT2", Graph = "1000g (no-CEU) + GTEx introns", count = 0, MapQ0 = 0, MapQ1 = 0, Filter = "MapQ0_frac", Frac = 0) %>%
  add_row(Method = "HISAT2", Graph = "1000g (no-CEU) + GTEx introns", count = 0, MapQ0 = 0, MapQ1 = 0, Filter = "MapQ1_frac", Frac = 0) %>%
  add_row(Method = "STAR", Graph = "1000g (no-CEU) + GTEx introns", count = 0, MapQ0 = 0, MapQ1 = 0, Filter = "MapQ0_frac", Frac = 0) %>%
  add_row(Method = "STAR", Graph = "1000g (no-CEU) + GTEx introns", count = 0, MapQ0 = 0, MapQ1 = 0, Filter = "MapQ1_frac", Frac = 0) 
...
overlap_data_polya_mapq_bar$Graph = recode_factor(overlap_data_polya_mapq_bar$Graph, 
                                            ...
                                            "1000g (no-CEU)" = "1000g\n(no-CEU)",
                                            "1000g (no-CEU) + GTEx introns" = "1000g (no-CEU)\n+ GTEx introns")

pdf("plots/polya_rna/real_overlap_polya_mapq_bar.pdf", height = 4, width = 5, pointsize = 12)
ggplot() +
